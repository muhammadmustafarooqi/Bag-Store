const { Product, Order, Coupon } = require('@kaarvan/db');
...
exports.trackOrder = async (req, res, next) => {
  try {
    ...
    // Search order by orderId (case-insensitive) and phone match
    ...
    // Return sanitized data to prevent exposing full user details
