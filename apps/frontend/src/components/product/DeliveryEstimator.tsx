...
const DELIVERY_ZONES = [
  { city: 'Lahore', days: '1-2 business days' },
  { city: 'Karachi', days: '3-4 business days' },
  { city: 'Islamabad', days: '2-3 business days' },
  { city: 'Rawalpindi', days: '2-3 business days' },
  { city: 'Faisalabad', days: '2-3 business days' },
  { city: 'Multan', days: '3-4 business days' },
  { city: 'Peshawar', days: '3-5 business days' },
  { city: 'Quetta', days: '4-6 business days' },
  { city: 'Other Cities (Punjab)', days: '3-4 business days' },
  { city: 'Other Cities (Sindh)', days: '4-5 business days' },
  { city: 'Other Cities (KPK/Balochistan)', days: '5-7 business days' }
];
