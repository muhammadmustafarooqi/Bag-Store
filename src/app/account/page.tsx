            ...
            <nav className="space-y-1">
              {tabs.map((t) => (
                <button
                  ...
                  style={{
                    background:
                      tab === t.key ? "rgba(200,169,110,0.08)" : "transparent",
                    borderLeft:
                      tab === t.key
                        ? "2px solid #c8a96e"
              ...
              >
                ...
                <div className="space-y-4 max-w-md">
                  {[
                    ...
                    <div key={f.label}>
                      ...
                      <p className="mt-1 text-sm" style={{ color: "#f0e4ce" }}>
                        {f.value}
                      </p>
                    </div>
                  ))}
                ...
                {user.role === "admin" && (
                  <Link
                    ...
                    className="btn-primary mt-6 inline-block text-sm px-6 py-3"
                  >
              ...
              <div>
                ...
                {ordersLoading ? (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-right">
                              ...
                              <span
                                className={`text-xs px-2 py-0.5 rounded-full ${ORDER_STATUS_COLORS[order.orderStatus] || "status-placed"}`}
                              >
                                {order.orderStatus}
                              </span>
                            </div>
                  ...
                  <div className="text-center py-16">
                    ...
                    <Link
                      href="/shop"
                      className="btn-primary mt-4 inline-block text-sm px-6"
                    >
                      Shop Now
                    </Link>
                  </div>
              ...
              <div>
                ...
                {wishlistLoading ? (
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
                    {[...Array(3)].map((_, i) => <div key={i} className="aspect-[3/4] skeleton" />)}
                  </div>
                  ...
                  <div className="text-center py-16">
                    <FiHeart size={48} className="mx-auto mb-4" style={{ color: '#3a3228' }} />
                    <p style={{ color: '#7a6a54' }}>Your wishlist is empty</p>
                    <Link href="/shop" className="btn-primary mt-4 inline-block text-sm px-6">Browse Shop</Link>
                  </div>
                )}
              </div>
            )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {user.addresses.map((addr) => (
                      <div
                        ...
                        style={{
                          background: "#221f1b",
                          border: `1px solid ${addr.isDefault ? "#c8a96e" : "rgba(200,169,110,0.15)"}`,
                        }}
                      >
                        <p
                        ...
                        <p className="text-sm" style={{ color: "#f0e4ce" }}>
                          {addr.street}
                        </p>
